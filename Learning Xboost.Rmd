...
---
  ...
  + fit an xgboost model with arbitrary and random hyperparameters
  + evaluate the loss (AUC-ROC) using cross-validation using xgboost package and caret
  + plot the training versus testing evaluation metrics
